...
def _get_config_dir():
    """Return OS-standard app data directory for 802_Manager."""
    ...
    config_dir = os.path.join(base, '802_Manager')
    os.makedirs(config_dir, exist_ok=True)
    return config_dir

CONFIG_FILE_NAME = os.path.join(_get_config_dir(), CONFIG_JSON)
